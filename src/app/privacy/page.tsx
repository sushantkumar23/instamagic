  ...
  return (
    <div className="relative py-16 overflow-hidden bg-white">
      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        <div className="mx-auto mb-12 text-lg max-w-prose">
          <h1>
        ...
        <div className="mx-auto space-y-6 text-lg leading-8 text-gray-500 max-w-prose">
          <p>
            Satria Technologies Private Limited (the “Company”, “we”, or “us”)
            respects your privacy. This Privacy Policy Statement (“Privacy
            Policy”) describes the ways we collect information from and about
            you, what we do with the information, and your privacy rights. By
            accessing our website, or purchasing our products or services, you
            agree to this Privacy Policy in addition to any other agreements we
            might have with you. In the event that such agreements contain terms
            that conflict with this Privacy Policy, the terms of those
            agreements will prevail.
          </p>
          <h2 className="font-bold">Scope</h2>
          <p>
            This Privacy Policy includes the Company’s Privacy Policy Statement.
            It applies to personal data processed by us in our business,
          ...
          <p>
            ...
            selections and other data that may identify you. We collect personal
          ...
          <ul role="list">
            ...
            <li>
              when the websites or mobile apps send us error reports or
              application analytics data;
            </li>
            <li>
              when you provide content on our forums, blogs, or social media
              pages.
            </li>{" "}
          </ul>
          <p>
          ...
          <p>
            ...
            information may include your Internet protocol (IP) address, user
            settings, MAC address, cookie identifiers, mobile carrier, mobile
            advertising and other unique identifiers, details about your
            browser, operating system or device, location information, Internet
            service provider, pages that you visit before, during and after
            using the Services, information about the links you click, and other
            information about how you use the Services. Information we collect
            may be associated with accounts and other devices. Our Services,
            such as those related to location data management, may collect
            precise geolocation information in accordance with applicable law.
          </p>
          <p>
            In addition, we may automatically collect data regarding your use of
            our Services, such as the types of content you interact with and the
            frequency and duration of your activities. Unless contrary to
            applicable law or contractual agreement, we may combine your
            information with information that other people provide when they use
            our Services, including, when the option is available, information
          ...
          <p>
            ...
            are essentially small data files placed on your computer, tablet,
            mobile phone, or other devices that allow us and our partners to
          ...
          <ul role="list">
            ...
            <li>
              ...
              collects information about users’ engagement on that web page. The
          ...
          <p>
            ...
            service for the marketing analysis of the site provided by Google,
            Inc. Google Analytics uses cookies to allow us to see how you use
            our site, so we can improve your experience. Google’s ability to use
            and share information collected by Google Analytics about your
            visits to the site is restricted by the Google Analytics Terms of
            Use available at{" "}
            <a
          ...
          <p>
            ...
            public via your privacy settings. Information we collect through
            ...
            information allows us to verify information that you have provided
          ...
          <ul>
            ...
            <li>
              managing our business, and allowing you to register for events
            </li>
          </ul>
          <p>
          ...
          <ul>
            ...
            <li>
              performing research and analysis about your use of, or interest
              in, our Services or content offered by others, and short-term,
              transient use, such as contextual customization of ads;
            </li>{" "}
            <li>
              undertaking research for technological development and
              demonstration; improving, upgrading or enhancing our Services or
              device or those of our Providers;
            </li>
          ...
          <ul role="list">
            ...
            <li>
              performing functions you consent to or that are otherwise
              described to you at the time of collection.
            </li>
          </ul>
          <p>
            <strong>Use De-identified and Aggregated Information.</strong> We
            may use personal data and other data about you to create
            de-identified and aggregated information, such as de-identified
          ...
          <p>
            Share Content with Friends or Colleagues. Our Services may offer
            various tools and functionalities. For example, we may allow you to
            provide information about your friends or colleagues through our
          ...
          <p>
            ...
            of their own, which may contain personal data. The data that we
            process through our Services is processed by us on behalf of our
            customer, and our privacy practices will be governed by the
            contracts that we have in place with our customers, not this Privacy
            Policy.
          </p>
          <p>
            If you have any questions or concerns about how such data is handled
            or would like to exercise your rights, you should contact the person
            or entity (i.e., the data controller) who has contracted with us to
            use the Service to process this data. Our customers control the
            personal data in these cases and determine the security settings
            within the account, its access controls and credentials. We will,
            however, provide assistance to our customers to address any concerns
            you may have, in accordance with the terms of our contract with
          ...
          <ul>
            <li>
              ...
              group, as well as with vendors who perform functions on our
              behalf; such parties provide hosting and maintenance services,
              virtual infrastructure, payment processing, analysis and other
              services for us;
            </li>
            <li>
              <strong>Contractors.</strong> third-party contractors may have
              access to our databases. Usually these contractors sign a standard
              confidentiality agreement;
            </li>{" "}
            <li>
              <strong>Business Partners.</strong> we may share your data with
              any parent company, subsidiaries, joint ventures, other entities
              under a common control or third-party acquirers. We expect these
              other entities will honor this Privacy Policy;
            </li>
            <li>
              <strong>
                Disclosure for Merger, Sale or Other Asset Transfer.
              </strong>{" "}
            ...
            <li>
              <strong>Disclosure to Protect Us or Others.</strong> as required
              by law enforcement, government officials, or other third parties
              pursuant to a subpoena, court order, or other legal process or
              requirement applicable to our Company; or when we believe, in our
              sole discretion, that the disclosure of personal data is necessary
              to prevent physical harm or financial loss; to report suspected
              illegal activity or to investigate violations of our agreements or
              Company policies; to enforce our terms and conditions, to protect
              the security or integrity of our products and services, and
            </li>{" "}
            <li>
          ...
          <p>
            Please note that these third parties may be in other countries where
            the laws on processing personal data may be less stringent than in
            your country.
          </p>
          <p>
            <strong>Potential for Other Users to Contact You.</strong> To the
            extent that a given application supports personal messaging
            functionality between and among end users, you may receive personal
            messages from other end users. You can disable this functionality by
          ...
          <p>
            ...
            to help ensure its security. This site has security measures in
            place to help protect information under our control from the risk of
            accidental or unlawful destruction or accidental loss, alteration or
            unauthorized disclosure or access. However, “perfect security” does
            not exist on the Internet. Also, if this website contains links to
          ...
          <ul role="list">
            <li>
              ...
              and tools that are required to identify irregular site behavior,
              prevent fraudulent activity and improve security or that allow you
            ...
            <li>
              <strong>Functionality Related.</strong> We may use Technologies
              that allow us to offer you enhanced functionality when accessing
              or using our Services. This may include identifying you when you
          ...
          <p>
            <strong>Website Links.</strong> We may create links to other
            websites. We will make a reasonable effort to link only to sites
            that meet similar standards for maintaining each individual’s right
            to privacy. However, many other sites that are not associated with
            or authorized by our Company may have links leading to our site. Our
            ...
            questions before you disclose any personal data to others.
          </p>
          <p>
            <strong>App Links.</strong> A given application may provide you with
            an advertising link to other, third-party sites and applications.
            Such third-party sites will have their own data collection practices
            and policies. Please review the privacy policy for such sites and
            exercise caution in providing information that personally identifies
            you. We have no responsibility, access, or control over the data
            collection practices and policies of such third-party sites and
            applications. You will use such sites and applications at your own
            risk and outside of the scope of this Privacy Policy. The provision
            of such advertisements is done on an “As Is” basis, with no
            endorsements or representations.
          </p>
          <p>
            <strong>Cross-Device Tracking.</strong> Your browsing activity may
            be tracked across different websites and different devices or apps.
            For example, we may attempt to match your browsing activity on your
            mobile device with your browsing activity on your laptop. To do this
            our technology partners may share data, such as your browsing
          ...
          <p>
            ...
            Our Company websites and mobile apps may use third parties to
            present or serve the advertisements that you may see at its web
            pages and to conduct research about the advertisements and web
            usage. This Privacy Policy does not cover any use of information
            that such third parties may have collected from you or the methods
            used by the third parties to collect that information. We do not
          ...
          <p>
            ...
            you assume the risk that the personal data provided by you may be
            viewed and used by third parties for any number of purposes. In
            addition, social media buttons such as Twitter and LinkedIn (that
            might include widgets such as the “share this” button or other
            interactive mini-programs) may be on our site. These features may
            ...
            apart from your visit to our site are governed by the privacy policy
            of the company providing it.
          </p>
          <p>
            We may use third-party APIs and software development kits (“SDKs”)
            as part of the functionality of our Services. APIs and SDKs may
            allow third parties including analytics and advertising partners to
            collect your personal data for various purposes including to provide
            analytics services and content that is more relevant to you. For
          ...
          <p>
            ...
            collection. The collection of your personal data will be limited to
            that which is needed for the purposes identified by our Company.
            Unless you consent, or we are required by law, we will only use the
            personal data for the purposes for which it was collected. If our
            Company will be processing your personal data for another purpose
            later on, our Company will seek your further legal permission or
            consent; except where the other purpose is compatible with the
            original purpose. We will keep your personal data only as long as
            required to serve those purposes. We will also retain and use your
          ...
          <p>
            ...
            software and services, you consent to the transfer of your
            information outside of your country. Such countries may have laws
          ...
          <p>
            ...
            requested. If you would like us to delete any personal data held
            about you, we will do so on request unless we need to hold the
          ...
          <p>
            ...
            processing of your personal data, you may withdraw that consent at
            any time and prevent further processing by contacting us as
            described below. Even if you opt out, we may still collect and use
            non- personal data regarding your activities on our Services and for
            other legal purposes as described above.
          </p>
          <p>
            <strong>Marketing.</strong> You may manage your receipt of marketing
            and non- transactional communications by clicking on the
            “unsubscribe” link located on the bottom of our marketing emails.
            Note that you will continue to receive transaction-related emails
          ...
          <p>
            ...
            your mobile device. We may also collect location-based information
          ...
          <p>
            ...
            which you may opt out of receiving targeted ads from data partners
            and other advertising partners that participate in self-regulatory
            programs.{" "}
          </p>
          <p>
          ...
          <ul>
            <li>
              ...
              was originally collected. Please note, however, that we may need
              to retain certain information for record keeping purposes, to
              complete transactions or to comply with our legal obligations,
              among other things.
            </li>
            <li>
              <strong>Right to object to processing.</strong> You may have the
              right to request that we stop processing your personal data,
              including the right to opt in or opt out of the sale of your
              Personal Data to third parties, or to stop sending you marketing
              communications.
            </li>
            <li>
              ...
              in certain circumstances. For example, where you believe that the
              personal data we hold about you is inaccurate or unlawfully held.
            </li>
            <li>
              <strong>Right to data portability:</strong> In certain
              circumstances, you may have the right to be provided with your
              personal data in a structured, machine readable and commonly used
              format and to request that we transfer the personal data to
              another data controller without hindrance.
            </li>
          </ul>
          <p>
            If you would like to exercise any of the above rights, please
            contact our support team or contact our Data Protection Officer (see
            our contact details in the “Contacting Us” Section below). We will
            consider your request in accordance with applicable laws. To protect
          ...
          <p>
            ...
            your employer), that organization is the administrator of the
            services and is responsible for the accounts and/or service over
            which it has control. Please direct your data privacy questions to
            your administrator, as your use of the services is subject to that
          ...
          <ul>
            ...
            <li>
              change your information, including profile information associated
              with your account; and
            </li>{" "}
            <li>
              allow you or restrict your ability to edit, restrict, modify or
              delete information.
            </li>
          </ul>
          <p>
          ...
          <p>
            ...
            receive any information from anyone under the age of 17 (or other
            age as required by local law). If you are a parent or guardian and
            you are aware that your child has provided us with personal data,
            please contact us immediately. If we learn that we have collected
            any personal data in violation of applicable law, we will promptly
